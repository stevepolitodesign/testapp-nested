...
class ShippingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_address" do
    assert_difference('ShippingAddress.count') do
      post shipping_addresses_url, params: { shipping_address: { address_line1: @shipping_address.address_line1, address_line2: @shipping_address.address_line2, city: @shipping_address.city, country: @shipping_address.country, state: @shipping_address.state, user_id: @shipping_address.user_id } }
    end
  ...
  test "should update shipping_address" do
    patch shipping_address_url(@shipping_address), params: { shipping_address: { address_line1: @shipping_address.address_line1, address_line2: @shipping_address.address_line2, city: @shipping_address.city, country: @shipping_address.country, state: @shipping_address.state, user_id: @shipping_address.user_id } }
